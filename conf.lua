function love.conf(t)
    t.releases = {
        title = "Mosquito Simulator 2k21",  -- The project title (string)
        package = "ms2k21",                 -- The project command and package name (string)
        ...
        identifier = "com.twilightfeel.ld.ms2k21",  -- The project Uniform Type Identifier (string)
        excludeFileList = {},               -- File patterns to exclude. (string list)
        releaseDirectory = "..",            -- Where to store the project releases (string)
    }

    -- The name of the save directory (string)
    t.identity = "com.twilightfeel.ld.ms2k21"
    ...
    t.window.title = "ms2k21"              -- The window title (string)
